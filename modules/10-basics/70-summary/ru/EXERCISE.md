...
В мире существует множество разных билетов: на транспорт, в кино, в театр и так далее. И, как правило, у каждого билета есть свой индивидуальный номер. Считается, что билет счастливый, если сумма цифр, входящих в этот билет с самого начала и до середины, равна сумме цифр после середины этого числа. Например, если номер билета _723428_, то нам нужно сложить _7 + 2 + 3_ и сравнить это с _4 + 2 + 8_. Данный билет счастливым не является.
